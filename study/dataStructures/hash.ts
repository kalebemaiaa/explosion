export type h_node = { key: number, removed: boolean, frequency: number, [key: string]: any};
...
export class HashTable {
    ...
    insert(value: number, optionalObject?: { [key: string]: any }): void {
        let count: number = 0;
        const newElement: h_node = { ...{ key: value, removed: false, frequency: 1 }, ...optionalObject };
